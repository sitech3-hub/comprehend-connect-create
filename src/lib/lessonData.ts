    ...
    vocab: [
      {
        ...
        choices: ["a small detail of something", "an unimportant addition", "the basic and most important quality of something", "a chemical reaction"],
      ...
      },
      {
        ...
        choices: ["extremely important", "optional and minor", "delayed in time", "easily replaced"],
      ...
      },
      {
        ...
        choices: ["to keep something going over time", "to ignore", "to destroy gradually", "to replace quickly"],
      ...
      },
      {
        ...
        choices: ["related to space exploration", "related to manufacturing cars", "related to banking", "related to farming"],
        answer: "related to farming",
      },
      {
        word: "emission",
        definition: "the production and discharge of something, especially gas or radiation",
        choices: ["a written report", "the storage of water", "a kind of music", "the release of gas into the air"],
    ...
    grammar: [
      {
        ...
        choices: ["expects", "expecting", "is expected", "has expect"],
        answer: "is expected",
      ...
      },
      {
        ...
        choices: ["To feeding", "Fed", "Feeding", "Feed"],
        answer: "Feeding",
      ...
      },
      {
        ...
        choices: ["associated", "association", "associating", "associate"],
        answer: "associated",
  ...
  },
  {
    ...
    grammar: [
      ...
      },
      {
        ...
        choices: ["noun phrase", "adverbial of time", "reduced relative clause modifying 'insect flour'", "imperative"],
    ...
    vocab: [
      {
        ...
        choices: ["to keep something the same", "to slightly improve", "to delay", "to change something completely"],
        answer: "to change something completely",
      },
      {
        word: "underlying",
        definition: "lying beneath the surface; fundamental",
        choices: ["irrelevant", "obvious and visible", "decorative", "fundamental and basic"],
        answer: "fundamental and basic",
      },
      {
        word: "adequate",
        definition: "satisfactory or acceptable in quality or quantity",
        choices: ["completely missing", "far too little", "barely enough or sufficient", "luxurious"],
        answer: "barely enough or sufficient",
      },
      {
        word: "yield",
        definition: "to produce or provide a natural, agricultural, or industrial product",
        choices: ["to delay", "to refuse", "to consume entirely", "to produce or give as a result"],
        answer: "to produce or give as a result",
      },
      {
        word: "habitat",
        definition: "the natural home or environment of an animal, plant, or other organism",
        choices: ["a kind of food", "a man-made factory", "a written law", "a natural environment of a living thing"],
    ...
    grammar: [
      {
        ...
        choices: ["Either", "Neither", "Not only", "Both"],
        answer: "Not only",
  ...
  },
  {
    ...
    grammar: [
      ...
      // ── 독립부정사 5문항 ──
      {
        ...
        choices: ["Being honest", "To honest", "To be honest", "Honest to be"],
        answer: "To be honest",
      ...
      },
      {
        ...
        choices: ["To making matters worse", "Make matters worse", "To make matter worse", "To make matters worse"],
      ...
      },
      {
        ...
        choices: ["Tell the truth", "Telling the truth", "To telling the truth", "To tell the truth"],
      ...
      },
      {
        ...
        choices: ["Need not to say", "Needing to say", "No need to say", "Needless to say"],
      ...
      },
      {
        ...
        choices: ["To so speak", "So speaking", "Speaking so", "So to speak"],
        answer: "So to speak",
