    ...
    vocab: [
      {
        ...
        choices: ["an unimportant addition", "a small detail of something", "the basic and most important quality of something", "a chemical reaction"],
      ...
      },
      {
        ...
        choices: ["easily replaced", "extremely important", "delayed in time", "optional and minor"],
      ...
      },
      {
        ...
        choices: ["to destroy gradually", "to replace quickly", "to keep something going over time", "to ignore"],
      ...
      },
      {
        ...
        choices: ["related to farming", "related to manufacturing cars", "related to space exploration", "related to banking"],
        answer: "related to farming",
      },
      {
        word: "emission",
        definition: "the production and discharge of something, especially gas or radiation",
        choices: ["a kind of music", "the release of gas into the air", "a written report", "the storage of water"],
    ...
    grammar: [
      {
        ...
        choices: ["expecting", "is expected", "expects", "has expect"],
        answer: "is expected",
      ...
      },
      {
        ...
        choices: ["Fed", "To feeding", "Feed", "Feeding"],
        answer: "Feeding",
  ...
  },
  {
    ...
    grammar: [
      ...
      },
      {
        ...
        choices: ["adverbial of time", "imperative", "reduced relative clause modifying 'insect flour'", "noun phrase"],
  ...
  },
  {
    ...
    vocab: [
      {
        ...
        choices: ["to slightly improve", "to keep something the same", "to delay", "to change something completely"],
        answer: "to change something completely",
      },
      {
        word: "underlying",
        definition: "lying beneath the surface; fundamental",
        choices: ["fundamental and basic", "decorative", "irrelevant", "obvious and visible"],
        answer: "fundamental and basic",
      },
      {
        word: "adequate",
        definition: "satisfactory or acceptable in quality or quantity",
        choices: ["barely enough or sufficient", "luxurious", "far too little", "completely missing"],
        answer: "barely enough or sufficient",
      },
      {
        word: "yield",
        definition: "to produce or provide a natural, agricultural, or industrial product",
        choices: ["to refuse", "to produce or give as a result", "to consume entirely", "to delay"],
        answer: "to produce or give as a result",
      },
      {
        word: "habitat",
        definition: "the natural home or environment of an animal, plant, or other organism",
        choices: ["a kind of food", "a natural environment of a living thing", "a man-made factory", "a written law"],
    ...
    grammar: [
      ...
      },
      {
        ...
        choices: ["consider", "to considering", "considering", "considered"],
        answer: "considering",
  ...
  },
  {
    ...
    grammar: [
      ...
      // ── 독립부정사 5문항 ──
      {
        ...
        choices: ["Being honest", "To be honest", "Honest to be", "To honest"],
        answer: "To be honest",
      ...
      },
      {
        ...
        choices: ["To make matter worse", "To making matters worse", "Make matters worse", "To make matters worse"],
      ...
      },
      {
        ...
        choices: ["Telling the truth", "Tell the truth", "To telling the truth", "To tell the truth"],
      ...
      },
      {
        ...
        choices: ["So to speak", "Speaking so", "To so speak", "So speaking"],
        answer: "So to speak",
